// Slider move
const prodContainer = document.getElementById("prod-slider");
...
slider(prodContainer, prodContainer.children[1], prodContainer.children[2]);
